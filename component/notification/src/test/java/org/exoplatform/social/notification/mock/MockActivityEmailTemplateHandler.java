...
import org.exoplatform.social.notification.template.ActivityEmailTemplateHandler;
@ChannelConfigs (
   id = "email",
   templates = {
...
public class MockActivityEmailTemplateHandler extends ActivityEmailTemplateHandler {

  public MockActivityEmailTemplateHandler() {
    super();
  }
